...
// Create the SIP listening point and bind it to the local
...
Address addressTo = this . addressFactory . createAddress (
...
// The " CSeq " header .
CSeqHeader cSeqHeader = this . headerFactory . createCSeqHeader (
1L ,"INVITE");
// The " From " header .
...
// Display the response message in the text area .
   // this.textArea.append("\ nReceived response : "+response.toString());
    }
